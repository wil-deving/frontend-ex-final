                ...
                <HashRouter>
                    <nav>
                        ...
                        <ul>
                            ...
                            <li>
                                <span><Link className="gen-item" to="/cotizacion">Cotizacion</Link></span>
                            </li>
                            <li>
                                <span className="gen-item">Reportes</span>
                                <ul>
                                    <li><span><Link className="gen-item" to="/">Cotizaciones</Link></span></li>
                            ...
                            <li>
                                <span className="gen-item">Ventas</span>
                                <ul>
                                    <li><Link className="gen-item" to="/">Nueva Venta</Link></li>
                                    <li><Link className="gen-item" to="/">Ventas Hechas</Link></li>
                                </ul>
                            </li>
                        </ul>
                    </nav>
