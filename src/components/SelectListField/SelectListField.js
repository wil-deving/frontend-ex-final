...
class SelectListField extends Component {
  ...
  /*
    ...
    * onClick-> Funcion que ejecutara en el componente
  ...
  componentWillMount() {
    ...
    if (
      this.state.defaultSelected !== null &&
      this.state.defaultSelected !== undefined &&
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (
      nextProps.onClickOption !== undefined &&
      nextProps.onClickOption !== null
    ) {
  ...
  onSelectedOption() {
    ...
    if (
      this.state.onClickOption !== undefined &&
      this.state.onClickOption !== null
    ) {
    ...
    return (
      <div hidden={!this.state.visible} className="general-select">
        <div className="cont-tag-comp comp-select-def">
          <label className="lbl-tag-comp-select">
        ...
        <div className="cont-select-ops">
          <select
            ...
            className="select-comp comp-select-def"
